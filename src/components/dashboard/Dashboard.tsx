      ...
      <div className="flex flex-col">
        ...
        <div className="border flex flex-col gap-4 p-6 px-4">
          <div className="border flex flex-col gap-4 bg-[#161b2f] rounded-2xl overflow-hidden">
            <Image src="https://i.imgur.com/Os59mPm.jpeg" width={5000} height={5000} className="" alt="sjsusbnnsn" />

            <div className="text-white p-3 px-7 pb-7">
              #ExpeditionFinance
              <br />
              In these videos, Jürgen Schmitt explores the latest trends and technologies.{' '}
            </div>
          </div>
        </div>
      </div>
