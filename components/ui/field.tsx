  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'has-data-[state=checked]:bg-[#034466]/5 has-data-[state=checked]:border-primary dark:has-data-[state=checked]:bg-[#034466]/10',
        className
      )}
      {...props}
    />
  ...
  return (
    <p
      ...
      className={cn(
        ...
        '[&>a:hover]:text-[#034466] [&>a]:underline [&>a]:underline-offset-4',
        className
      )}
      {...props}
    />
